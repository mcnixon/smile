...
print('Radius is '+str(round(r_earthlike,2))+' Earth radii (should be 0.98)')
...
print('Radius is '+str(round(r_subnep,2))+' Earth radii (should be 3.08)')

print('Running sub-Neptune test case (mixed envelope):')

# Sub-Neptune model
# 5% differentiated envelope, half H2O, half H/He, Earth-like nucleus
r_subnep = smile.get_radius(10.0,P0=1e4,T0=500.0,Pad=1e6,x_w=0.025,x_g=0.025,mixed=True,profiles=True)

print('Radius is '+str(round(r_subnep,2))+' Earth radii (should be 2.63)')
